	...
	<div class="contmain">
		...
		<div class="boxi">
			...
			<form action="<?php echo U('User/edit');?>" method="post">
				<div class="boxin">
					<span>用&nbsp;&nbsp;户&nbsp;&nbsp;名</span><input type="text" class="form-control" name="username" value="<?php echo ($user_data["username"]); ?>">
				</div>
				<div class="boxin">
					<span>昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称</span><input type="text" class="form-control" name="nickname" value="<?php echo ($user_data["nickname"]); ?>">
				</div>
				<div class="boxin">
					<span>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</span><input type="text"  class="form-control" name="email" value="<?php echo ($user_data["email"]); ?>">
				</div>
				<div class="boxin">
				...
				<?php if($user_data['user_id'] != 1): ?><div class="boxin">
					<span>所属角色</span>
