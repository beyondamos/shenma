	...
	<div class="contmain">
		...
		<div class="boxi">
			...
			<form action="" method="post">
				<div class="boxin">
					<span>分类名称</span><input type="text"  class="form-control" name="name" value="<?php echo ($videoc_data["name"]); ?>"> 
				</div>
				<div class="boxinb">
		          <div class="boxinbl">
		            <span>上级分类</span>
		            <select name="parent_id" class="form-control">
		              ...
		              <?php if(is_array($videocs)): $i = 0; $__LIST__ = $videocs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $videoc_data['parent_id']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		            </select>
		          </div>
		        </div>
				<div class="boxin">
					<span>描述</span>
					<textarea class="form-control" name="desc" rows="5" cols="80"><?php echo ($videoc_data["desc"]); ?></textarea>
				</div>
				<div class="boxinbtn">
					<input type="hidden" name="id" value="<?php echo ($videoc_data["id"]); ?>">
