       ...
       <div class="contmain">
          ...
          <div class="boxi">
             ...
             <form action="<?php echo U('Banner/edit');?>" method="post" enctype="multipart/form-data">
              ...
              <?php if($banner['id'] == 6 || $banner['id'] == 5 || $banner['id'] == 9 || $banner['id'] == 10 || $banner['id'] == 12): ?><div class="boxinb">
               <span>注：</span>图片 宽度1920px 高度525px
               </div><?php endif; ?>
               <?php if($banner['id'] == 18): ?><div class="boxinb">
               <span>注：</span>图片 宽度1750px 高度1330px
               </div><?php endif; ?>
               <?php if($banner['id'] == 11): ?><div class="boxinb">
               <span>注：</span>图片 宽度1200px 高度700px
               </div><?php endif; ?>
              <?php if($banner['classify'] == 1): ?><div class="boxinb">
               <span>注：</span>图片 宽度1920px 高度680px
               </div><?php endif; ?>
                <?php if($banner['classify'] == 8): ?><div class="boxinb">
               <span>注：</span>图片 宽度810px 高度190px
               </div><?php endif; ?>
               <?php if($banner['classify'] == 4 || $banner['classify'] == 9): ?><div class="boxinb">
