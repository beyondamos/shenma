          ...
          <div class="boxi">
             ...
             <form action="<?php echo U('Banner/edit');?>" method="post" enctype="multipart/form-data">
               ...
               <div class="boxinb">
                ...
                <img id="thumbnail" src="<?php echo ($banner["thumbnail"]); ?>" width="300px" height="200px" >
                <input id="article-thumbnail" type="hidden" name="thumbnail" value="<?php echo ($banner["thumbnail"]); ?>">
               </div> 
                <div class="boxinb">
