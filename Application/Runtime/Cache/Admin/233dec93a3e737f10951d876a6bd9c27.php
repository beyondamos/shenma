	...
	<div class="contmain">
		...
		<div class="boxi">
			...
			<form action="" method="post">
				<div class="boxin">
					<span>分类名称</span><input type="text"  class="form-control" name="name">
				</div>
				<div class="boxinb">
		          <div class="boxinbl">
		            <span>上级导航</span>
		            <select name="parent_id" class="form-control">
		              ...
		              <?php if(is_array($videoc_data)): $i = 0; $__LIST__ = $videoc_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		            </select>
		          </div>
		        </div>
                <div class="boxin">
                    <span>描述</span><textarea class="form-control" name="desc" rows="5" cols="80"></textarea>
