	...
	<div class="contmain">
		<div class="boxi">
			...
			<form action="<?php echo U('Category/add');?>" method="post">
				<div class="boxin">
					<span>姓名</span><input type="text" name="name" class="form-control" value="<?php echo ($message["name"]); ?>">
				</div>
				<div class="boxin">
					<span>手机</span><input type="text" class="form-control" name="phone" value="<?php echo ($message["phone"]); ?>">
				</div>
				<div class="boxin">
					<span>邮箱</span><input type="text" class="form-control" name="email" value="<?php echo ($message["email"]); ?>">
				</div>
				<div class="boxtext">
					<span>留言信息</span><textarea rows="6" class="form-control" name="info"><?php echo ($message["info"]); ?></textarea>
				</div>

				<div class="boxinbtn">
				<a href="<?php echo U('Message/delete', array('id' => $message['id']));?>">删除留言</a>
				<a href="<?php echo U('Message/index');?>">返回</a>
				</div>
