	...
	<div class="contmain">
		...
		<div class="boxi">
			...
			<form action="" method="post">
				<div class="boxin">
					<span class="lets3">用&nbsp;户&nbsp;名</span><input type="text"  class="form-control" readonly="readonly" name="username" value="<?php echo ($login_user_data["username"]); ?>">
				</div>
				<div class="boxin">
					<span class="lets3">昵&nbsp;&nbsp;&nbsp;称</span><input type="text"  class="form-control" name="nickname" value="<?php echo ($login_user_data["nickname"]); ?>">
				</div>
				<div class="boxin">
					<span class="lets3">新&nbsp;密&nbsp;码</span><input type="password" name="password" class="form-control">
				</div>
				<div class="boxin">
