             ...
             <form action="<?php echo U('Carousel/add');?>" method="post" enctype="multipart/form-data">
              ...
              <span>左侧图</span><span>665x955</span>
                  ...
                  <div id="uploader-demo">
                      ...
                      <input id="thumbnail1" type="hidden" name="thumbnail1" value="">
                      <div id="fileList1" class="uploader-list"></div>
                      <img id="oldimg1" src="" width="300px" height="200px" style="display:none">
                  </div>
            </div>
              <div class="boxinb">
              <span>右侧图</span><span>1255x955</span>
                  <div id="uploader-demo">
                      ...
                      <input id="thumbnail2" type="hidden" name="thumbnail2" value="">
                      <div id="fileList2" class="uploader-list"></div>
                      <img id="oldimg2" src="" width="300px" height="200px" style="display:none">
                  </div>
            </div>
            <div class="boxinb">
                  ...
                  <div id="uploader-demo">
                      ...
                      <input id="thumbnail3" type="hidden" name="thumbnail3" value="">
                      <div id="fileList3" class="uploader-list"></div>
                       <img id="oldimg3" src="" width="300px" height="200px" style="display:none">
                  </div>
            </div>
