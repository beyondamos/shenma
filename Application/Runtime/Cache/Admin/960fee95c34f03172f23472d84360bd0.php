    ...
    <div class="cont">
       <div class="contmain">
          ...
          <div class="boxi">
             ...
             <form action="<?php echo U('Icon/edit');?>" method="post" enctype="multipart/form-data">
                <div class="boxin">
                   <span>名称</span><input type="text" name="name" class="form-control" value="<?php echo ($icon["name"]); ?>">
               </div>
                <div class="boxin">
                   <span>英文名称</span><input type="text" name="name_e" class="form-control" value="<?php echo ($icon["name_e"]); ?>">
               </div>

               <div class="boxinb">
                   <span>链&nbsp;接&nbsp;地&nbsp;址</span><input type="text" name="url" class="form-control" value="<?php echo ($icon["url"]); ?>">
               </div>
              <div class="boxinb">
                    <div id="uploader-demo">
                        ...
                        <input id="thumbnail" type="hidden" name="thumbnail" value="<?php echo ($icon["thumbnail"]); ?>">
                        <img id="oldimg" src="<?php echo ($icon["thumbnail"]); ?>" width="300px" height="200px">
