	...
	<div class="contmain">
		...
		<div class="boxi">
			...
			<table class="table table-hover boxtable">
				...
				<tbody>
					<?php if(is_array($category_data)): $i = 0; $__LIST__ = $category_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td class="text-vm"><?php echo ($vo["cate_id"]); ?></td>
