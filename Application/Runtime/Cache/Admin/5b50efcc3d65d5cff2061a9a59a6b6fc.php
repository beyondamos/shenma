...
<div class="cont">
	<div class="contmain">
		...
		<div class="boxi">
			...
			<form action="<?php echo U('Friendlink/edit');?>" method="post" enctype="multipart/form-data">
				<div class="boxin">
					<span>链&nbsp;接&nbsp;名&nbsp;称</span><input type="text" name="name" class="form-control" value="<?php echo ($friendlink_data["name"]); ?>">
				</div>
				<div class="boxin">
				...
				<div class="boxinb">
                <span>链接图片</span>
                <a href="javascript:;" class="form-control upfn"><input type="file" id='file_upload'  name="file_upload" /></a><i class="upfnb"><?php echo ($friendlink_data["thumbnail"]); ?></i>
                </div>
	            ...
	            <div class="boxinb">
	                <div class="boxinbl">
	                    ...
	                    <select name="status" class="form-control">
	                        <option value="0" <?php if($friendlink_data['status'] == 0): ?>selected<?php endif; ?>>禁用</option>
	                        <option value="1" <?php if($friendlink_data['status'] == 1): ?>selected<?php endif; ?>>启用</option>  
	                    </select>
	                </div>
	            </div>
	            <div class="boxinb">
	                <div class="boxinbl">
	                    ...
	                    <select name="is_blank" class="form-control">
	                        <option value="0" <?php if($friendlink_data['is_blank'] == 0): ?>selected<?php endif; ?>>否</option>
	                        <option value="1" <?php if($friendlink_data['is_blank'] == 1): ?>selected<?php endif; ?>>是</option>  
	                    </select>
	                </div>
	            </div>
