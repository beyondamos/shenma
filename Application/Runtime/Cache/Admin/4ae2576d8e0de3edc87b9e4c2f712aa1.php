       ...
       <div class="contmain">
          ...
          <div class="boxi">
             ...
             <form action="<?php echo U('Develop/edit');?>" method="post" enctype="multipart/form-data">
                <div class="boxin">
                   <span>历程名称</span>
                   <textarea name="title" class="form-control" rows="5"><?php echo ($develop["title"]); ?></textarea>
                   <!-- <input type="text" name="title" class="form-control" value="<?php echo ($develop["title"]); ?>"> -->
               </div>
              <div class="boxinb">
            ...
            <span class="lets2">日&nbsp;&nbsp;&nbsp;&nbsp;期</span><input type="text" id="demo"  class="form-control laydate-icon" name="newstime"  value="<?php echo ($develop["newstime"]); ?>">
               ...
               <input type="hidden" name="id" value="<?php echo ($develop["id"]); ?>">
                              <div class="boxinb">
               <span>注：</span>图片 宽度280px 高度200px
               </div>
            <div class="boxinbtn">
