...
<div class="cont">
	<div class="contmain">
		...
		<div class="boxi">
			...
			<form action="<?php echo U('Info/index');?>" method="post" enctype="multipart/form-data">
				<div class="boxinb">
					<span>文章标题</span><input type="text" class="form-control"  name="title" value="<?php echo ($info["title"]); ?>">
				</div>
                <?php if($info['id'] != 2): ?><div class="boxinb">
                    <div id="uploader-demo">
                        <!--用来存放item-->
                        
                        <div id="filePicker">选择图片</div>
                        <input id="thumbnail" type="hidden" name="thumbnail" value="<?php echo ($info["thumbnail"]); ?>">
                        <img id="oldimg" src="<?php echo ($info["thumbnail"]); ?>" width="300px" height="200px">
