		...
		<div class="boxi">
			...
			<form action="<?php echo U('Article/edit');?>" method="post" enctype="multipart/form-data">
				...
				<div class="boxinb">
					...
					<label><input type="checkbox" name="status" <?php if($article_data['status'] == 1): ?>checked<?php endif; ?> />发布</label>
				</div>
				<div class="boxinb">
					<div class="boxinbl">
				...
				<div class="boxinb">
					<span class="lets2">点&nbsp;击&nbsp;量</span><input type="text"  class="form-control"  value="<?php echo ($article_data["click"]); ?>"  name="click">
				</div>
				<div class="boxinb">
              ...
              <div class="boxinb">
                    <div id="uploader-demo">
                        ...
                        <input id="thumbnail" type="hidden" name="thumbnail" value="<?php echo ($article_data["thumbnail"]); ?>">
                        <img id="oldimg" src="<?php echo ($article_data["thumbnail"]); ?>" width="300px" height="200px">
