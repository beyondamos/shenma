    ...
    <div class="cont">
       <div class="contmain">
          ...
          <div class="boxi">
             ...
             <form action="<?php echo U('Team/edit');?>" method="post" enctype="multipart/form-data">
                <div class="boxin">
                   <span>姓&nbsp;&nbsp;&nbsp;&nbsp;名</span><input type="text" name="name" class="form-control" value="<?php echo ($team["name"]); ?>">
               </div>
                <div class="boxin">
                   <span>职&nbsp;&nbsp;&nbsp;&nbsp;务</span><input type="text" name="post" class="form-control" value="<?php echo ($team["post"]); ?>">
               </div>
              <div class="boxinb">
                    <div id="uploader-demo">
                        ...
                        <input id="thumbnail" type="hidden" name="thumbnail" value="<?php echo ($team["thumbnail"]); ?>">
                        <img id="oldimg" src="<?php echo ($team["thumbnail"]); ?>" width="300px" height="200px">
                        <div id="fileList" class="uploader-list"></div>
                    </div>
              </div>
                <div class="boxinb">
                   <span>简&nbsp;&nbsp;&nbsp;&nbsp;介</span><input type="text" name="content" class="form-control" value="<?php echo ($team["content"]); ?>">
               </div>
                <div class="boxinb">
                   <span>顺&nbsp;&nbsp;&nbsp;&nbsp;序</span><input type="text" name="sort" class="form-control" value="<?php echo ($team["sort"]); ?>">
               </div>
