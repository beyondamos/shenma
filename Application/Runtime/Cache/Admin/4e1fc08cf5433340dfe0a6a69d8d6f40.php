			...
			<form action="<?php echo U('brand/edit');?>" method="post" enctype="multipart/form-data">
              ...
              <div class="boxinb">
                    <div id="uploader-demo">
                        ...
                        <input id="thumbnail" type="hidden" name="thumbnail" value="<?php echo ($brand_data["thumbnail"]); ?>">
                        <img id="oldimg" src="<?php echo ($brand_data["thumbnail"]); ?>" width="300px" height="200px">
	                ...
	                <div class="boxinbl">
	                    ...
	                    <select name="is_blank" class="form-control">
	                        ...
	                        <option value="1" <?php if($brand_data['is_blank'] == 1): ?>selected<?php endif; ?>>是</option>  
                              ...
                              <div class="boxinb">
                   <span>顺&nbsp;&nbsp;&nbsp;&nbsp;序</span><input type="text" name="sort" class="form-control" value="<?php echo ($brand_data["sort"]); ?>">
               </div>
       <div class="boxinb">
               <span>注：</span>图片 宽度300px 高度210px
               </div>
