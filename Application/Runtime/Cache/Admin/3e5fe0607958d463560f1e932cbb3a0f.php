    ...
    <div class="cont">
       <div class="contmain">
          ...
          <div class="boxi">
             ...
             <form action="<?php echo U('Add/edit');?>" method="post" enctype="multipart/form-data">
                <div class="boxin">
                   <span>名称</span><input type="text" name="name" class="form-control" value="<?php echo ($add["name"]); ?>">
               </div>
               <div class="boxinb">
                   <span>链&nbsp;接&nbsp;地&nbsp;址</span><input type="text" name="url" class="form-control" value="<?php echo ($add["url"]); ?>">
               </div>
              ...
              <div class="boxinb">
                    <div id="uploader-demo">
                        ...
                        <input id="thumbnail" type="hidden" name="thumbnail" value="<?php echo ($add["thumbnail"]); ?>">
                        <img id="oldimg" src="<?php echo ($add["thumbnail"]); ?>" width="300px" height="200px">
                        <div id="fileList" class="uploader-list"></div>
                    </div>
              </div>

                <div class="boxinb">
                   <span>顺&nbsp;&nbsp;&nbsp;&nbsp;序</span><input type="text" name="sort" class="form-control" value="<?php echo ($add["sort"]); ?>">
               </div>
