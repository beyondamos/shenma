...
<div class="cont">
	<div class="contmain">
		...
		<div class="boxi">
			...
			<!-- 表格顶部搜索区 -->
			<div class="boxoper">
				<a href="<?php echo U('Carousel/add');?>">添加轮播图</a>
			...
			<table class="table table-hover boxtable">
				<thead>
					<tr>
					   ...
					   <th class="col-md-2 text-vm">轮播图名称</th>
					   
					   <th class="col-md-1 text-vm">顺序</th>
				...
				<tbody>
					<?php if(is_array($carousels)): $i = 0; $__LIST__ = $carousels;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td class="text-vm">
							<a href="<?php echo U('Carousel/edit',array('id' => $vo['id']) );?>">编辑</a>
							<a href="<?php echo U('Carousel/delete',array('id' => $vo['id']) );?>">删除</a>
						</td>
