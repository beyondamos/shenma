...
<div style="float:left" id="my_menu" class="sdmenu">
	...
	<div>	
		<span>老板商学院<i class="glyphicon glyphicon-plus" aria-hidden="true"></i></span>
		<a href="<?php echo U('Bannerm/edit', array('id' => 12));?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Banner图设置</a>
	</div>
	<div><span></span></div>
...
<div class="cont">
	<div class="contmain">
		...
		<div class="boxi">
			...
			<!-- 表格顶部搜索区 -->
			<div class="boxoper">
				<a href="<?php echo U('Bannerm/add', array('classify' => $classify ));?>">添加Banner</a>
			...
			<table class="table table-hover boxtable">
				...
				<tbody>
					<?php if(is_array($banners)): $i = 0; $__LIST__ = $banners;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td class="text-vm">
							<a href="<?php echo U('Bannerm/edit',array('id' => $vo['id']) );?>">编辑</a>
							<?php if($vo['classify'] != 4): ?><a href="<?php echo U('Bannerm/delete',array('id' => $vo['id'], 'classify' => $classify ));?>">删除</a><?php endif; ?>
						</td>
