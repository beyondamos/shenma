...
<div class="cont">
	<div class="contmain">
		...
		<div class="boxi">
			...
			<!-- 表格顶部搜索区 -->
			<div class="boxoper">
				<a href="<?php echo U('Add/add', array('classify' => $classify ));?>">添加信息</a>
			...
			<table class="table table-hover boxtable">
				...
				<tbody>
					<?php if(is_array($adds)): $i = 0; $__LIST__ = $adds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td class="text-vm">
							<a href="<?php echo U('Add/edit',array('id' => $vo['id']) );?>">编辑</a>
							<?php if($vo['classify'] != 4): ?><a href="<?php echo U('Add/delete',array('id' => $vo['id'], 'classify' => $classify ));?>">删除</a><?php endif; ?>
						</td>
