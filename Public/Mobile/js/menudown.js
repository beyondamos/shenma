$(function(){
    ...
    $(".select_textdiv").click(function(){
    	$(".select_textdiv").removeClass("divselfocus");
    	$(this).addClass("divselfocus");
    	$(this).siblings(".select_textul").fadeToggle(300);
        var lilength = $(this).siblings(".select_textul").find("li.selfocus").has(".select_second_ul").length;
    	if(lilength > 0){
    		$(this).siblings(".select_textul").find("li.selfocus>.select_second_ul").show();
    	}else{
	...
	$(".select_first_ul>li>p").click(function(){
		...
		$(this).parent("li").addClass("selfocus").siblings("li").removeClass("selfocus");
	...
	function chooseclick(){
		$(".select_second_ul>li").click(function(){
			var choose = $(this).text();
			$(this).addClass("selfocusli").siblings("li").removeClass("selfocusli");
			$(this).parents(".select_textul").siblings(".select_textdiv").find(".s_text").text(choose);
			$(this).parents(".select_textul").siblings("input").val(choose);
			$(this).parents(".select_textul").fadeOut(300);
