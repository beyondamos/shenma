...
CREATE TABLE IF NOT EXISTS `shenma_seo` (
  ...
  `synopsis` text NOT NULL COMMENT '描述',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='SEO表' AUTO_INCREMENT=1 ;
...
(1, 'chunming', 'xiaoming1', 'b897633a5e0f7dc503be11173d669b3a', '328122186@qq.com', '1232', 1, 1507713647, 2130706433, 0, 67, 1),
