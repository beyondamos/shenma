...
--
-- Host: localhost
-- Generation Time: 2017-10-09 07:25:45
-- 服务器版本： 5.5.48-log
-- PHP Version: 5.6.22
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='新闻内容表';
...
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='新闻内容表';
...
(1, 'http://shunwei.com/', '顺为资本', 1, '/Public/Upload/20170915/1505439830_1471526976.png', 0),
(2, 'https://www.freesvc.com/', '峰瑞资本', 1, '/Public/Upload/20170915/1505439306_1759848785.png', 0),
(3, 'http://www.nlightvc.com/', '北极光创投', 1, '/Public/Upload/20170915/1505439354_1960900315.png', 0),
(4, 'http://www.chinagrowthcapital.com/', '华创资本', 1, '/Public/Upload/20170930/1506781619_16857160.png', 0),
(5, 'http://www.chinaequity.net/', '信中利', 1, '/Public/Upload/20170915/1505439420_1036568804.png', 0),
(6, 'http://honda-sundiro.com/', '新大洲本田', 1, '/Public/Upload/20170915/1505439443_1689504697.png', 0),
(7, 'http://www.yadea.com.cn/', '雅迪电动车', 1, '/Public/Upload/20170915/1505439467_1699157341.png', 0),
(8, 'http://www.haojue.com/', '豪爵', 1, '/Public/Upload/20170915/1505439493_937432950.png', 0),
(9, 'http://jsjpcy.ddc.net.cn/', '金彭', 1, '/Public/Upload/20170915/1505439521_533915130.png', 0),
(10, 'http://honda-sundiro.com/', '新大洲', 1, '/Public/Upload/20170915/1505439543_239773102.png', 0);
...
(3, '', '/Public/Upload/20170930/1506741670_43823339.png', '/Public/Upload/20170930/1506741676_1073981964.png', '/Public/Upload/20170930/1506742489_59077280.png', 10);
...
CREATE TABLE IF NOT EXISTS `shenma_config` (
  `conf_id` smallint(5) unsigned NOT NULL COMMENT '配置id',
...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='发展历程表';
...
CREATE TABLE IF NOT EXISTS `shenma_icon` (
  ...
  `thumbnail` varchar(256) NOT NULL COMMENT '缩略图'
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Banner图标';
...
CREATE TABLE IF NOT EXISTS `shenma_post` (
  ...
  `cate_id` int(11) NOT NULL DEFAULT '0' COMMENT '父级ID',
  `content` text NOT NULL COMMENT '页面内容'
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='职位表';
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='产品表2';
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='核心团队';
...
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='核心团队';
...
(1, 'chunming', 'xiaoming1', 'b897633a5e0f7dc503be11173d669b3a', '328122186@qq.com', '1232', 1, 1506770450, 2147483647, 0, 62, 1),
...
--
-- Indexes for table `shenma_about`
--
ALTER TABLE `shenma_about`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_article`
--
ALTER TABLE `shenma_article`
  ADD PRIMARY KEY (`article_id`);

--
-- Indexes for table `shenma_auth`
--
ALTER TABLE `shenma_auth`
  ADD PRIMARY KEY (`auth_id`);

--
-- Indexes for table `shenma_banner`
--
ALTER TABLE `shenma_banner`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_brand`
--
ALTER TABLE `shenma_brand`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_carousel`
--
ALTER TABLE `shenma_carousel`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_config`
--
ALTER TABLE `shenma_config`
  ADD PRIMARY KEY (`conf_id`);

--
-- Indexes for table `shenma_department`
--
ALTER TABLE `shenma_department`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_develop`
--
ALTER TABLE `shenma_develop`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_icon`
--
ALTER TABLE `shenma_icon`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_info`
--
ALTER TABLE `shenma_info`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_message`
--
ALTER TABLE `shenma_message`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_nav`
--
ALTER TABLE `shenma_nav`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_post`
--
ALTER TABLE `shenma_post`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_product`
--
ALTER TABLE `shenma_product`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_productf`
--
ALTER TABLE `shenma_productf`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_qc`
--
ALTER TABLE `shenma_qc`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_question`
--
ALTER TABLE `shenma_question`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_role`
--
ALTER TABLE `shenma_role`
  ADD PRIMARY KEY (`role_id`);

--
-- Indexes for table `shenma_team`
--
ALTER TABLE `shenma_team`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `shenma_user`
--
ALTER TABLE `shenma_user`
...
--
-- AUTO_INCREMENT for table `shenma_about`
--
ALTER TABLE `shenma_about`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `shenma_article`
--
ALTER TABLE `shenma_article`
  MODIFY `article_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `shenma_auth`
--
ALTER TABLE `shenma_auth`
  MODIFY `auth_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '权限id',AUTO_INCREMENT=91;
--
-- AUTO_INCREMENT for table `shenma_banner`
--
ALTER TABLE `shenma_banner`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `shenma_brand`
--
ALTER TABLE `shenma_brand`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `shenma_carousel`
--
ALTER TABLE `shenma_carousel`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `shenma_config`
--
ALTER TABLE `shenma_config`
  MODIFY `conf_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '配置id',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `shenma_department`
--
ALTER TABLE `shenma_department`
  MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类id',AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT for table `shenma_develop`
--
ALTER TABLE `shenma_develop`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `shenma_icon`
--
ALTER TABLE `shenma_icon`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `shenma_info`
--
ALTER TABLE `shenma_info`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `shenma_message`
--
ALTER TABLE `shenma_message`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `shenma_nav`
--
ALTER TABLE `shenma_nav`
  MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '导航id',AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `shenma_post`
--
ALTER TABLE `shenma_post`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `shenma_product`
--
ALTER TABLE `shenma_product`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `shenma_productf`
--
ALTER TABLE `shenma_productf`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `shenma_qc`
--
ALTER TABLE `shenma_qc`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `shenma_question`
--
ALTER TABLE `shenma_question`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `shenma_role`
--
ALTER TABLE `shenma_role`
  MODIFY `role_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '角色id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `shenma_team`
--
ALTER TABLE `shenma_team`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `shenma_user`
--
ALTER TABLE `shenma_user`
  MODIFY `user_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户id',AUTO_INCREMENT=9;
